 ...
 */
class AuthMenuItemsController : MenuItemsFacade {

    lateinit var mMenuItems: ArrayList<MenuItem>
    private val observer = object : ObservableOnSubscribe<MenuItem> {
        override fun subscribe(e: ObservableEmitter<MenuItem>) {
